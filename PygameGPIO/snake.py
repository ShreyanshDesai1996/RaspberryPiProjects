...
leftpin=17
uppin=18
GPIO.setup(leftpin,GPIO.IN,GPIO.PUD_DOWN)
GPIO.setup(uppin,GPIO.IN,GPIO.PUD_DOWN)
GPIO.add_event_detect(leftpin, GPIO.RISING,bouncetime=200)
GPIO.add_event_detect(uppin, GPIO.RISING,bouncetime=200)
while True:
	clock.tick(10)
	if GPIO.event_detected(leftpin):
		print('left button pressed')
		dirs=3
	if GPIO.event_detected(uppin):
