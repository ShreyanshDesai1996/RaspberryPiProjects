...
threshold=100 #this will be the sideways threshold
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    if(cx<320-threshold): #turn right
        print('Turn right')
    if(cx>320+threshold): #turn left
        print('Turn left')

    cv2.drawContours(image,c,-1,(0,255,0),3)
    cv2.line(image,(320,0),(320,480),(255,0,0),5) #center line
    cv2.line(image,(320-threshold,0),(320-threshold,480),(0,0,255),2) #left threshold
    cv2.line(image,(320+threshold,0),(320+threshold,480),(0,0,255),2) #right threshold
