...
pwm1.start(30) #right wheel
pwm2.start(30) #left wheel
...
pid = PID(0.8, 0.2, 0.05, output_limits=(-70,70) ,setpoint=0)
pid2 = PID(0.8, 0.2, 0.05, output_limits=(-70,70) ,setpoint=0)
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    if(dist<8):
        ...
        #white=False
        print('Obstruction detected,stopped till clear')
